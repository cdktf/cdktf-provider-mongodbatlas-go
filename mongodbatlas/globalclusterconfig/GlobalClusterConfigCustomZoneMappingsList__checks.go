...
func (g *jsiiProxy_GlobalClusterConfigCustomZoneMappingsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (g *jsiiProxy_GlobalClusterConfigCustomZoneMappingsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
