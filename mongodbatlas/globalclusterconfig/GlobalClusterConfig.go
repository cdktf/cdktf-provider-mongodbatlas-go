...
// Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.21.1/docs/resources/global_cluster_config mongodbatlas_global_cluster_config} Resource.
...
func GlobalClusterConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGlobalClusterConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlobalClusterConfig) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlobalClusterConfig) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GlobalClusterConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GlobalClusterConfig) MoveFromId(id *string) {
...
func (g *jsiiProxy_GlobalClusterConfig) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GlobalClusterConfig) MoveToId(id *string) {
...
func (g *jsiiProxy_GlobalClusterConfig) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GlobalClusterConfig) ToHclTerraform() interface{} {
	var returns interface{}
