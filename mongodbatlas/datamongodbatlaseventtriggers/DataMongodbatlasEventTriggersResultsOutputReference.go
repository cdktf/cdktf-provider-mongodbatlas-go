...
func (d *jsiiProxy_DataMongodbatlasEventTriggersResultsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasEventTriggersResultsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
