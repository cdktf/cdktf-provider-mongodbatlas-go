...
func (d *jsiiProxy_DataMongodbatlasEventTriggersResultsEventProcessorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasEventTriggersResultsEventProcessorsList) Resolve(context cdktf.IResolveContext) interface{} {
