...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSnapshotExportBucketsResultsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSnapshotExportBucketsResultsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
