...
import (
	...
	"github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/datamongodbatlasprojectipaccesslist/internal"
...
func (j *jsiiProxy_DataMongodbatlasProjectIpAccessList) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/mongodbatlas/d/project_ip_access_list mongodbatlas_project_ip_access_list} Data Source.
...
func (j *jsiiProxy_DataMongodbatlasProjectIpAccessList)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
