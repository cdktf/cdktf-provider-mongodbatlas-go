...
import (
	...
	"github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v8/datamongodbatlasprojectipaccesslist/internal"
...
// Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.40.0/docs/data-sources/project_ip_access_list mongodbatlas_project_ip_access_list} Data Source.
...
func DataMongodbatlasProjectIpAccessList_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataMongodbatlasProjectIpAccessList_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataMongodbatlasProjectIpAccessList) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataMongodbatlasProjectIpAccessList) ToHclTerraform() interface{} {
	var returns interface{}
