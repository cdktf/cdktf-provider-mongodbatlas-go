...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudBackupSnapshotExportBucket)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIamRoleId", GoMethod: "ResetIamRoleId"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.cloudBackupSnapshotExportBucket.CloudBackupSnapshotExportBucketConfig",
		reflect.TypeOf((*CloudBackupSnapshotExportBucketConfig)(nil)).Elem(),
	)
}
