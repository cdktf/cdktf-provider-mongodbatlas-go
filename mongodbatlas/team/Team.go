...
import (
	...
	"github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v7/team/internal"
...
func (j *jsiiProxy_Team) OrgId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"orgId",
...
func (j *jsiiProxy_Team) OrgIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"orgIdInput",
...
func (j *jsiiProxy_Team) TeamId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"teamId",
...
func (j *jsiiProxy_Team) Usernames() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"usernames",
...
func (j *jsiiProxy_Team) UsernamesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"usernamesInput",
...
// Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.21.3/docs/resources/team mongodbatlas_team} Resource.
func NewTeam(scope constructs.Construct, id *string, config *TeamConfig) Team {
	...
	_jsii_.Create(
		"@cdktf/provider-mongodbatlas.team.Team",
...
func (j *jsiiProxy_Team)SetOrgId(val *string) {
...
func (j *jsiiProxy_Team)SetUsernames(val *[]*string) {
