...
func (o *jsiiProxy_OnlineArchiveCriteriaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OnlineArchiveCriteriaOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
