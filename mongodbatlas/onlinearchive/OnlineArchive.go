...
// Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.16.0/docs/resources/online_archive mongodbatlas_online_archive} Resource.
...
func OnlineArchive_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOnlineArchive_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OnlineArchive) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OnlineArchive) ResetDataProcessRegion() {
	_jsii_.InvokeVoid(
		o,
		"resetDataProcessRegion",
		nil, // no parameters
...
func (o *jsiiProxy_OnlineArchive) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (o *jsiiProxy_OnlineArchive) ToHclTerraform() interface{} {
	var returns interface{}
