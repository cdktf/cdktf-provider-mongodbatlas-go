...
func (d *jsiiProxy_DataMongodbatlasClusterConnectionStringsPrivateEndpointEndpointsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasClusterConnectionStringsPrivateEndpointEndpointsList) Resolve(context cdktf.IResolveContext) interface{} {
