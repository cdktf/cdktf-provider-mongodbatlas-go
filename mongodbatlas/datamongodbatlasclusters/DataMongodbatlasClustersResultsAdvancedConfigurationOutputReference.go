...
func (j *jsiiProxy_DataMongodbatlasClustersResultsAdvancedConfigurationOutputReference) CustomOpensslCipherConfigTls12() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataMongodbatlasClustersResultsAdvancedConfigurationOutputReference) TlsCipherConfigMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tlsCipherConfigMode",
...
func (d *jsiiProxy_DataMongodbatlasClustersResultsAdvancedConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasClustersResultsAdvancedConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
