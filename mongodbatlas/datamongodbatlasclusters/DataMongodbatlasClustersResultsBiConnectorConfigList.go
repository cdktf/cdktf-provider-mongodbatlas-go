...
func (d *jsiiProxy_DataMongodbatlasClustersResultsBiConnectorConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasClustersResultsBiConnectorConfigList) Resolve(context cdktf.IResolveContext) interface{} {
