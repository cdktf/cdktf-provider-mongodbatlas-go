...
func (d *jsiiProxy_DataMongodbatlasClustersResultsSnapshotBackupPolicyOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasClustersResultsSnapshotBackupPolicyOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
