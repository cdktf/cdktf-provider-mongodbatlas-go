...
func (d *jsiiProxy_DataMongodbatlasClustersResultsConnectionStringsPrivateEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasClustersResultsConnectionStringsPrivateEndpointList) Resolve(context cdktf.IResolveContext) interface{} {
