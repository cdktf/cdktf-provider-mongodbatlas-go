...
func (d *jsiiProxy_DataMongodbatlasClustersResultsSnapshotBackupPolicyPoliciesPolicyItemList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasClustersResultsSnapshotBackupPolicyPoliciesPolicyItemList) Resolve(context cdktf.IResolveContext) interface{} {
