...
func (d *jsiiProxy_DataMongodbatlasClustersResultsConnectionStringsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasClustersResultsConnectionStringsList) Resolve(context cdktf.IResolveContext) interface{} {
