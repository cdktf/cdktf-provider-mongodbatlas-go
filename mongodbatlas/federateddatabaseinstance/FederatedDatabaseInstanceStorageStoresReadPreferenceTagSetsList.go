...
func (f *jsiiProxy_FederatedDatabaseInstanceStorageStoresReadPreferenceTagSetsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FederatedDatabaseInstanceStorageStoresReadPreferenceTagSetsList) Resolve(context cdktf.IResolveContext) interface{} {
