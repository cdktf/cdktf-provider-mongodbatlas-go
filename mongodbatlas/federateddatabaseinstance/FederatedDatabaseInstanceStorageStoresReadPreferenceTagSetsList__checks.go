...
func (f *jsiiProxy_FederatedDatabaseInstanceStorageStoresReadPreferenceTagSetsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (f *jsiiProxy_FederatedDatabaseInstanceStorageStoresReadPreferenceTagSetsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
