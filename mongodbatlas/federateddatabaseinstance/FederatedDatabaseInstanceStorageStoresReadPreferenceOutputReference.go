...
func (f *jsiiProxy_FederatedDatabaseInstanceStorageStoresReadPreferenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FederatedDatabaseInstanceStorageStoresReadPreferenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
