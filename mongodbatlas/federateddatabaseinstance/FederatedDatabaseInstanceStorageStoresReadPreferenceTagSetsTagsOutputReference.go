...
func (f *jsiiProxy_FederatedDatabaseInstanceStorageStoresReadPreferenceTagSetsTagsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FederatedDatabaseInstanceStorageStoresReadPreferenceTagSetsTagsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
