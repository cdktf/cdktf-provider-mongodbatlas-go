...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isSlowOperationThresholdingEnabledInput", GoGetter: "IsSlowOperationThresholdingEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsSlowOperationThresholdingEnabled", GoMethod: "ResetIsSlowOperationThresholdingEnabled"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.project.ProjectIpAddresses",
		reflect.TypeOf((*ProjectIpAddresses)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-mongodbatlas.project.ProjectIpAddressesOutputReference",
		reflect.TypeOf((*ProjectIpAddressesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.project.ProjectIpAddressesServices",
		reflect.TypeOf((*ProjectIpAddressesServices)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.project.ProjectIpAddressesServicesClusters",
		reflect.TypeOf((*ProjectIpAddressesServicesClusters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-mongodbatlas.project.ProjectIpAddressesServicesClustersList",
		reflect.TypeOf((*ProjectIpAddressesServicesClustersList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ProjectIpAddressesServicesClustersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ProjectIpAddressesServicesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
