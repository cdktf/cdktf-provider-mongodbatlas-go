...
func (d *jsiiProxy_DataMongodbatlasFederatedSettingsOrgConfigsResultsRoleMappingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasFederatedSettingsOrgConfigsResultsRoleMappingsList) Resolve(context cdktf.IResolveContext) interface{} {
