...
func (d *jsiiProxy_DataMongodbatlasFederatedSettingsOrgConfigsResultsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasFederatedSettingsOrgConfigsResultsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
