...
func (d *jsiiProxy_DataMongodbatlasFederatedSettingsOrgConfigsResultsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasFederatedSettingsOrgConfigsResultsList) Resolve(context cdktf.IResolveContext) interface{} {
