...
func (d *jsiiProxy_DataMongodbatlasAdvancedClustersResultsConnectionStringsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasAdvancedClustersResultsConnectionStringsList) Resolve(context cdktf.IResolveContext) interface{} {
