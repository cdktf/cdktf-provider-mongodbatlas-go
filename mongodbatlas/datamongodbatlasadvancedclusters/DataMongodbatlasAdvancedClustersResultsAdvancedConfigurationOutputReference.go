...
func (j *jsiiProxy_DataMongodbatlasAdvancedClustersResultsAdvancedConfigurationOutputReference) CustomOpensslCipherConfigTls12() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataMongodbatlasAdvancedClustersResultsAdvancedConfigurationOutputReference) DefaultMaxTimeMs() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"defaultMaxTimeMs",
...
func (j *jsiiProxy_DataMongodbatlasAdvancedClustersResultsAdvancedConfigurationOutputReference) TlsCipherConfigMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tlsCipherConfigMode",
...
func (d *jsiiProxy_DataMongodbatlasAdvancedClustersResultsAdvancedConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasAdvancedClustersResultsAdvancedConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
