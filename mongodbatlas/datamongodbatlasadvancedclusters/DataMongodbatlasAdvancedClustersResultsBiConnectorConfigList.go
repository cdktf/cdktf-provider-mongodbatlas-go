...
func (d *jsiiProxy_DataMongodbatlasAdvancedClustersResultsBiConnectorConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasAdvancedClustersResultsBiConnectorConfigList) Resolve(context cdktf.IResolveContext) interface{} {
