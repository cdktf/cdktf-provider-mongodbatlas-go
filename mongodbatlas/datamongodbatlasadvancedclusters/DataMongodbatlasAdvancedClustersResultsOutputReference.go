...
func (j *jsiiProxy_DataMongodbatlasAdvancedClustersResultsOutputReference) RedactClientLogData() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"redactClientLogData",
...
func (d *jsiiProxy_DataMongodbatlasAdvancedClustersResultsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasAdvancedClustersResultsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
