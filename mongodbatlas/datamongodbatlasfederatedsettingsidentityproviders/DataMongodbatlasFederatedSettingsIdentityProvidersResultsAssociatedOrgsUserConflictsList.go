...
func (d *jsiiProxy_DataMongodbatlasFederatedSettingsIdentityProvidersResultsAssociatedOrgsUserConflictsList) Resolve(context cdktf.IResolveContext) interface{} {
