...
// Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.35.1/docs/resources/privatelink_endpoint_service_serverless mongodbatlas_privatelink_endpoint_service_serverless} Resource.
...
func PrivatelinkEndpointServiceServerless_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePrivatelinkEndpointServiceServerless_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PrivatelinkEndpointServiceServerless) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PrivatelinkEndpointServiceServerless) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PrivatelinkEndpointServiceServerless) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PrivatelinkEndpointServiceServerless) MoveFromId(id *string) {
...
func (p *jsiiProxy_PrivatelinkEndpointServiceServerless) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PrivatelinkEndpointServiceServerless) MoveToId(id *string) {
...
func (p *jsiiProxy_PrivatelinkEndpointServiceServerless) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PrivatelinkEndpointServiceServerless) ToHclTerraform() interface{} {
	var returns interface{}
