...
func (d *jsiiProxy_DatabaseUserRolesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DatabaseUserRolesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
