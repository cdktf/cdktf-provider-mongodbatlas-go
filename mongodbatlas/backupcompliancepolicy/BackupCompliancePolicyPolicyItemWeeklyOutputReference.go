...
func (b *jsiiProxy_BackupCompliancePolicyPolicyItemWeeklyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupCompliancePolicyPolicyItemWeeklyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
