...
func (b *jsiiProxy_BackupCompliancePolicyOnDemandPolicyItemOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupCompliancePolicyOnDemandPolicyItemOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
