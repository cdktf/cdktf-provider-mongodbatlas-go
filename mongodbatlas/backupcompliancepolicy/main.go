...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "authorizedUserFirstNameInput", GoGetter: "AuthorizedUserFirstNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "authorizedUserLastName", GoGetter: "AuthorizedUserLastName"},
			_jsii_.MemberProperty{JsiiProperty: "authorizedUserLastNameInput", GoGetter: "AuthorizedUserLastNameInput"},
