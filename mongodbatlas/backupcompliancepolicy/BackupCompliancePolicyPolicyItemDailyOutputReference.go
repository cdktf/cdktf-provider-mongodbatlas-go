...
func (b *jsiiProxy_BackupCompliancePolicyPolicyItemDailyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupCompliancePolicyPolicyItemDailyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
