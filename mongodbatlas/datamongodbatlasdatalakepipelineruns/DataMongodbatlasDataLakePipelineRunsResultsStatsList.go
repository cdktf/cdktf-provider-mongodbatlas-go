...
func (d *jsiiProxy_DataMongodbatlasDataLakePipelineRunsResultsStatsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasDataLakePipelineRunsResultsStatsList) Resolve(context cdktf.IResolveContext) interface{} {
