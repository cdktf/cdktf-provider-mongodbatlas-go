...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSnapshotsResultsMembersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSnapshotsResultsMembersList) Resolve(context cdktf.IResolveContext) interface{} {
