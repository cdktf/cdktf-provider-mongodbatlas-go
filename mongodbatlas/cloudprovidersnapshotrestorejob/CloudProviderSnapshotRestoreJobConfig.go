...
type CloudProviderSnapshotRestoreJobConfig struct {
	// Experimental.
	...
	DeliveryTypeConfig *CloudProviderSnapshotRestoreJobDeliveryTypeConfig `field:"optional" json:"deliveryTypeConfig" yaml:"deliveryTypeConfig"`
