...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSnapshotExportJobsResultsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSnapshotExportJobsResultsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
