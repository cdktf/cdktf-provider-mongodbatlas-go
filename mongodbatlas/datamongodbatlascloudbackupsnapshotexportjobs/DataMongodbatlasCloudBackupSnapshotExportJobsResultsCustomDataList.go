...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSnapshotExportJobsResultsCustomDataList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSnapshotExportJobsResultsCustomDataList) Resolve(context cdktf.IResolveContext) interface{} {
