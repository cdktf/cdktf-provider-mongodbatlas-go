...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSnapshotExportJobsResultsComponentsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSnapshotExportJobsResultsComponentsList) Resolve(context cdktf.IResolveContext) interface{} {
