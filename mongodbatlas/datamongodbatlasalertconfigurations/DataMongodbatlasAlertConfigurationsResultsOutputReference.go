...
func (d *jsiiProxy_DataMongodbatlasAlertConfigurationsResultsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasAlertConfigurationsResultsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
