...
func (d *jsiiProxy_DataMongodbatlasServerlessInstancesResultsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasServerlessInstancesResultsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
