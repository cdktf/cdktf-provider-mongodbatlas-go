...
type DataMongodbatlasResourcePoliciesConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.39.0/docs/data-sources/resource_policies#org_id DataMongodbatlasResourcePolicies#org_id}
