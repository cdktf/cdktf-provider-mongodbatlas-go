...
func (d *jsiiProxy_DataMongodbatlasAdvancedClusterReplicationSpecsRegionConfigsElectableSpecsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasAdvancedClusterReplicationSpecsRegionConfigsElectableSpecsList) Resolve(context cdktf.IResolveContext) interface{} {
