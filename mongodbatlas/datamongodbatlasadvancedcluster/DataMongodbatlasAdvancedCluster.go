...
type DataMongodbatlasAdvancedCluster interface {
	...
	PinnedFcv() DataMongodbatlasAdvancedClusterPinnedFcvList
...
func (j *jsiiProxy_DataMongodbatlasAdvancedCluster) ConfigServerManagementMode() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataMongodbatlasAdvancedCluster) ConfigServerType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"configServerType",
...
func (j *jsiiProxy_DataMongodbatlasAdvancedCluster) GlobalClusterSelfManagedSharding() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataMongodbatlasAdvancedCluster) PinnedFcv() DataMongodbatlasAdvancedClusterPinnedFcvList {
	var returns DataMongodbatlasAdvancedClusterPinnedFcvList
	_jsii_.Get(
		j,
		"pinnedFcv",
		&returns,
...
func (j *jsiiProxy_DataMongodbatlasAdvancedCluster) RedactClientLogData() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"redactClientLogData",
...
func (j *jsiiProxy_DataMongodbatlasAdvancedCluster) ReplicaSetScalingStrategy() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataMongodbatlasAdvancedCluster) UseReplicationSpecPerShard() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataMongodbatlasAdvancedCluster) UseReplicationSpecPerShardInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.34.0/docs/data-sources/advanced_cluster mongodbatlas_advanced_cluster} Data Source.
...
func (j *jsiiProxy_DataMongodbatlasAdvancedCluster)SetUseReplicationSpecPerShard(val interface{}) {
...
func DataMongodbatlasAdvancedCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataMongodbatlasAdvancedCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataMongodbatlasAdvancedCluster) ResetUseReplicationSpecPerShard() {
	_jsii_.InvokeVoid(
		d,
		"resetUseReplicationSpecPerShard",
		nil, // no parameters
...
func (d *jsiiProxy_DataMongodbatlasAdvancedCluster) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataMongodbatlasAdvancedCluster) ToHclTerraform() interface{} {
	var returns interface{}
