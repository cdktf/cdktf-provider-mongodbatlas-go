...
func (d *jsiiProxy_DataMongodbatlasAdvancedClusterLabelsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasAdvancedClusterLabelsList) Resolve(context cdktf.IResolveContext) interface{} {
