...
func (d *jsiiProxy_DataMongodbatlasAdvancedClusterConnectionStringsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasAdvancedClusterConnectionStringsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
