...
func (d *jsiiProxy_DataMongodbatlasAdvancedClusterBiConnectorConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasAdvancedClusterBiConnectorConfigList) Resolve(context cdktf.IResolveContext) interface{} {
