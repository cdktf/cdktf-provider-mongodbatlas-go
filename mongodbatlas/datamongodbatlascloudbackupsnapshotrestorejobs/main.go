...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasCloudBackupSnapshotRestoreJobs)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.dataMongodbatlasCloudBackupSnapshotRestoreJobs.DataMongodbatlasCloudBackupSnapshotRestoreJobsConfig",
		reflect.TypeOf((*DataMongodbatlasCloudBackupSnapshotRestoreJobsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.dataMongodbatlasCloudBackupSnapshotRestoreJobs.DataMongodbatlasCloudBackupSnapshotRestoreJobsResults",
		reflect.TypeOf((*DataMongodbatlasCloudBackupSnapshotRestoreJobsResults)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasCloudBackupSnapshotRestoreJobsResultsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasCloudBackupSnapshotRestoreJobsResultsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
