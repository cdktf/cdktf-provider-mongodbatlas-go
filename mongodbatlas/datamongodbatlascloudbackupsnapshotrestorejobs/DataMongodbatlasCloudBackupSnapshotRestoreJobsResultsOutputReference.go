...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSnapshotRestoreJobsResultsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSnapshotRestoreJobsResultsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
