...
func (d *jsiiProxy_DataMongodbatlasProjectApiKeyProjectAssignmentList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasProjectApiKeyProjectAssignmentList) Resolve(context cdktf.IResolveContext) interface{} {
