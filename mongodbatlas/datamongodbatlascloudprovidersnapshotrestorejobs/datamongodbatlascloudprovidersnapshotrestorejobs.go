...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasCloudProviderSnapshotRestoreJobs)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.dataMongodbatlasCloudProviderSnapshotRestoreJobs.DataMongodbatlasCloudProviderSnapshotRestoreJobsConfig",
		reflect.TypeOf((*DataMongodbatlasCloudProviderSnapshotRestoreJobsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.dataMongodbatlasCloudProviderSnapshotRestoreJobs.DataMongodbatlasCloudProviderSnapshotRestoreJobsResults",
		reflect.TypeOf((*DataMongodbatlasCloudProviderSnapshotRestoreJobsResults)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasCloudProviderSnapshotRestoreJobsResultsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasCloudProviderSnapshotRestoreJobsResultsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
