...
type ThirdPartyIntegrationConfig struct {
	...
	LicenseKey *string `field:"optional" json:"licenseKey" yaml:"licenseKey"`
	...
	ReadToken *string `field:"optional" json:"readToken" yaml:"readToken"`
	...
	WriteToken *string `field:"optional" json:"writeToken" yaml:"writeToken"`
}
