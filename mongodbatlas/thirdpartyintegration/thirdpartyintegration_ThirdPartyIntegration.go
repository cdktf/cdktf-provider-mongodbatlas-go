...
import (
	...
	"github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/thirdpartyintegration/internal"
...
func (j *jsiiProxy_ThirdPartyIntegration) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ThirdPartyIntegration)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
