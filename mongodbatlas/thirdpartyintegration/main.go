...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSendCollectionLatencyMetrics", GoMethod: "ResetSendCollectionLatencyMetrics"},
			_jsii_.MemberMethod{JsiiMethod: "resetSendDatabaseMetrics", GoMethod: "ResetSendDatabaseMetrics"},
			_jsii_.MemberMethod{JsiiMethod: "resetSendUserProvidedResourceTags", GoMethod: "ResetSendUserProvidedResourceTags"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sendCollectionLatencyMetricsInput", GoGetter: "SendCollectionLatencyMetricsInput"},
			_jsii_.MemberProperty{JsiiProperty: "sendDatabaseMetrics", GoGetter: "SendDatabaseMetrics"},
			_jsii_.MemberProperty{JsiiProperty: "sendDatabaseMetricsInput", GoGetter: "SendDatabaseMetricsInput"},
			_jsii_.MemberProperty{JsiiProperty: "sendUserProvidedResourceTags", GoGetter: "SendUserProvidedResourceTags"},
			_jsii_.MemberProperty{JsiiProperty: "sendUserProvidedResourceTagsInput", GoGetter: "SendUserProvidedResourceTagsInput"},
