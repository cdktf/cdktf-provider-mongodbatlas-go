...
func (d *jsiiProxy_DataMongodbatlasCustomDbRolesResultsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasCustomDbRolesResultsList) Resolve(context cdktf.IResolveContext) interface{} {
