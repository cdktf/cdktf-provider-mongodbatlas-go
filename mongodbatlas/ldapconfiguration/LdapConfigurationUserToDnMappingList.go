...
func (l *jsiiProxy_LdapConfigurationUserToDnMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LdapConfigurationUserToDnMappingList) Resolve(context cdktf.IResolveContext) interface{} {
