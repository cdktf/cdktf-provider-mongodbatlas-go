...
func (l *jsiiProxy_LdapConfigurationUserToDnMappingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LdapConfigurationUserToDnMappingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
