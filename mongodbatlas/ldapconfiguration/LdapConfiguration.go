...
import (
	...
	"github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v7/ldapconfiguration/internal"
...
// Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.30.0/docs/resources/ldap_configuration mongodbatlas_ldap_configuration} Resource.
...
func LdapConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLdapConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LdapConfiguration) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LdapConfiguration) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LdapConfiguration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LdapConfiguration) MoveFromId(id *string) {
...
func (l *jsiiProxy_LdapConfiguration) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LdapConfiguration) MoveToId(id *string) {
...
func (l *jsiiProxy_LdapConfiguration) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LdapConfiguration) ToHclTerraform() interface{} {
	var returns interface{}
