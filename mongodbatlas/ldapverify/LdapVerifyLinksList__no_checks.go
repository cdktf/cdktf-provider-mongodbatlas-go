...
func (l *jsiiProxy_LdapVerifyLinksList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (l *jsiiProxy_LdapVerifyLinksList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
