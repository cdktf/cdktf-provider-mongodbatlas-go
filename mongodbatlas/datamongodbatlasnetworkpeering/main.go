...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasNetworkPeering)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.dataMongodbatlasNetworkPeering.DataMongodbatlasNetworkPeeringConfig",
		reflect.TypeOf((*DataMongodbatlasNetworkPeeringConfig)(nil)).Elem(),
	)
}
