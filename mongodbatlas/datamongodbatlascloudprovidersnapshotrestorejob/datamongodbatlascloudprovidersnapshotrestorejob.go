...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasCloudProviderSnapshotRestoreJob)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.dataMongodbatlasCloudProviderSnapshotRestoreJob.DataMongodbatlasCloudProviderSnapshotRestoreJobConfig",
		reflect.TypeOf((*DataMongodbatlasCloudProviderSnapshotRestoreJobConfig)(nil)).Elem(),
	)
}
