...
func (d *jsiiProxy_DataMongodbatlasDataLakePipelinesResultsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasDataLakePipelinesResultsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
