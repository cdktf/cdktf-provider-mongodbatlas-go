...
func (d *jsiiProxy_DataMongodbatlasDataLakePipelinesResultsSinkList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasDataLakePipelinesResultsSinkList) Resolve(context cdktf.IResolveContext) interface{} {
