...
func (d *jsiiProxy_DataMongodbatlasDataLakePipelinesResultsSinkPartitionFieldsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasDataLakePipelinesResultsSinkPartitionFieldsList) Resolve(context cdktf.IResolveContext) interface{} {
