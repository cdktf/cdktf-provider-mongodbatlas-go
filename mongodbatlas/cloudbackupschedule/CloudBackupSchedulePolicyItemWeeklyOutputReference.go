...
func (c *jsiiProxy_CloudBackupSchedulePolicyItemWeeklyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudBackupSchedulePolicyItemWeeklyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
