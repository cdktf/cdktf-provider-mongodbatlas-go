...
func (c *jsiiProxy_CloudBackupSchedulePolicyItemHourlyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudBackupSchedulePolicyItemHourlyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
