...
func (c *jsiiProxy_CloudBackupSchedulePolicyItemDailyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudBackupSchedulePolicyItemDailyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
