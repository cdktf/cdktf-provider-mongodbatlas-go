...
func (c *jsiiProxy_CloudBackupSchedulePolicyItemMonthlyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudBackupSchedulePolicyItemMonthlyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
