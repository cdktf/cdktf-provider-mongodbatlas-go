...
// Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.41.0/docs/resources/cloud_backup_schedule mongodbatlas_cloud_backup_schedule} Resource.
...
func CloudBackupSchedule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudBackupSchedule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudBackupSchedule) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudBackupSchedule) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudBackupSchedule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudBackupSchedule) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudBackupSchedule) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CloudBackupSchedule) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudBackupSchedule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudBackupSchedule) ToHclTerraform() interface{} {
	var returns interface{}
