...
func (c *jsiiProxy_CloudBackupScheduleExportOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudBackupScheduleExportOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
