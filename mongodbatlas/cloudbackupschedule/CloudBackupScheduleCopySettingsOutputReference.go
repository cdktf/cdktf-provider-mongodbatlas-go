...
func (c *jsiiProxy_CloudBackupScheduleCopySettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudBackupScheduleCopySettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
