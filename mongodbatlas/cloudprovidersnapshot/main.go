...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudProviderSnapshot)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.cloudProviderSnapshot.CloudProviderSnapshotConfig",
		reflect.TypeOf((*CloudProviderSnapshotConfig)(nil)).Elem(),
	)
}
