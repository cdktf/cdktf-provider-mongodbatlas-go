...
func (c *jsiiProxy_CloudBackupSnapshotRestoreJobDeliveryTypeConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudBackupSnapshotRestoreJobDeliveryTypeConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
