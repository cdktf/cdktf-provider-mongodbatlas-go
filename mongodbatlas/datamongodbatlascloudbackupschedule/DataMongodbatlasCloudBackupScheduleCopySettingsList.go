...
func (d *jsiiProxy_DataMongodbatlasCloudBackupScheduleCopySettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasCloudBackupScheduleCopySettingsList) Resolve(context cdktf.IResolveContext) interface{} {
