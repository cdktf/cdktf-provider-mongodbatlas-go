...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSchedulePolicyItemDailyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasCloudBackupSchedulePolicyItemDailyList) Resolve(context cdktf.IResolveContext) interface{} {
