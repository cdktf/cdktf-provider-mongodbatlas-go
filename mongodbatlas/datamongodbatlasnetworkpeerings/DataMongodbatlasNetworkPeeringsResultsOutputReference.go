...
func (d *jsiiProxy_DataMongodbatlasNetworkPeeringsResultsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasNetworkPeeringsResultsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
