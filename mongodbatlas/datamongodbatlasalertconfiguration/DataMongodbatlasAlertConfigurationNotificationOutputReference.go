...
func (j *jsiiProxy_DataMongodbatlasAlertConfigurationNotificationOutputReference) IntegrationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"integrationId",
...
func (d *jsiiProxy_DataMongodbatlasAlertConfigurationNotificationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasAlertConfigurationNotificationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
