...
func (d *jsiiProxy_DataMongodbatlasSharedTierSnapshotsResultsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasSharedTierSnapshotsResultsList) Resolve(context cdktf.IResolveContext) interface{} {
