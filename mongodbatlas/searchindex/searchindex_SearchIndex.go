...
func (j *jsiiProxy_SearchIndex) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SearchIndex) StatusInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statusInput",
...
func (j *jsiiProxy_SearchIndex)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (j *jsiiProxy_SearchIndex)SetStatus(val *string) {
...
func (s *jsiiProxy_SearchIndex) ResetStatus() {
	_jsii_.InvokeVoid(
		s,
		"resetStatus",
		nil, // no parameters
