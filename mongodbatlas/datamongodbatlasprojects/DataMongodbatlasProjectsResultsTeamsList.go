...
func (d *jsiiProxy_DataMongodbatlasProjectsResultsTeamsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasProjectsResultsTeamsList) Resolve(context cdktf.IResolveContext) interface{} {
