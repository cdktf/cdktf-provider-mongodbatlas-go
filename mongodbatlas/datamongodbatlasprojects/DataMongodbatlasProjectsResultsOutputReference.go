...
func (d *jsiiProxy_DataMongodbatlasProjectsResultsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasProjectsResultsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
