...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MongodbEmployeeAccessGrant)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.mongodbEmployeeAccessGrant.MongodbEmployeeAccessGrantConfig",
		reflect.TypeOf((*MongodbEmployeeAccessGrantConfig)(nil)).Elem(),
	)
}
