...
import (
	...
	"github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v8/federatedsettingsorgrolemapping/internal"
...
func (f *jsiiProxy_FederatedSettingsOrgRoleMappingRoleAssignmentsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FederatedSettingsOrgRoleMappingRoleAssignmentsList) Resolve(context cdktf.IResolveContext) interface{} {
