...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FederatedSettingsOrgRoleMapping)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "externalGroupNameInput", GoGetter: "ExternalGroupNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putRoleAssignments", GoMethod: "PutRoleAssignments"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "roleAssignments", GoGetter: "RoleAssignments"},
			_jsii_.MemberProperty{JsiiProperty: "roleAssignmentsInput", GoGetter: "RoleAssignmentsInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.federatedSettingsOrgRoleMapping.FederatedSettingsOrgRoleMappingConfig",
		reflect.TypeOf((*FederatedSettingsOrgRoleMappingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.federatedSettingsOrgRoleMapping.FederatedSettingsOrgRoleMappingRoleAssignments",
		reflect.TypeOf((*FederatedSettingsOrgRoleMappingRoleAssignments)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-mongodbatlas.federatedSettingsOrgRoleMapping.FederatedSettingsOrgRoleMappingRoleAssignmentsList",
		reflect.TypeOf((*FederatedSettingsOrgRoleMappingRoleAssignmentsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FederatedSettingsOrgRoleMappingRoleAssignmentsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
