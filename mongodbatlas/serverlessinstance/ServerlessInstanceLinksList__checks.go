...
func (s *jsiiProxy_ServerlessInstanceLinksList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_ServerlessInstanceLinksList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
