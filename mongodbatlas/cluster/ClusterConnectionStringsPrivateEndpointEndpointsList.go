...
func (c *jsiiProxy_ClusterConnectionStringsPrivateEndpointEndpointsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ClusterConnectionStringsPrivateEndpointEndpointsList) Resolve(context cdktf.IResolveContext) interface{} {
