...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customOpensslCipherConfigTls12Input", GoGetter: "CustomOpensslCipherConfigTls12Input"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCustomOpensslCipherConfigTls12", GoMethod: "ResetCustomOpensslCipherConfigTls12"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTlsCipherConfigMode", GoMethod: "ResetTlsCipherConfigMode"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tlsCipherConfigModeInput", GoGetter: "TlsCipherConfigModeInput"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
