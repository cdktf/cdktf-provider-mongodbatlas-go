...
func (c *jsiiProxy_Cluster) validatePutLabelsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ClusterLabels; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_Cluster) validatePutReplicationSpecsParameters(value interface{}) error {
	...
	case *[]*ClusterReplicationSpecs:
		value := value.(*[]*ClusterReplicationSpecs)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ClusterReplicationSpecs:
		value_ := value.([]*ClusterReplicationSpecs)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ClusterReplicationSpecs; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_Cluster) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ClusterTags; received %#v (a %T)", value, value)
		}
	}
