...
func (c *jsiiProxy_ClusterSnapshotBackupPolicyOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClusterSnapshotBackupPolicyOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
