...
func (c *jsiiProxy_ClusterSnapshotBackupPolicyPoliciesPolicyItemList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (c *jsiiProxy_ClusterSnapshotBackupPolicyPoliciesPolicyItemList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
