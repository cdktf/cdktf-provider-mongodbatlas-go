...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PrivatelinkEndpointServiceAdl)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.privatelinkEndpointServiceAdl.PrivatelinkEndpointServiceAdlConfig",
		reflect.TypeOf((*PrivatelinkEndpointServiceAdlConfig)(nil)).Elem(),
	)
}
