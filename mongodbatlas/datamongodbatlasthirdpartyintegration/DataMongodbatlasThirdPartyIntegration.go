...
import (
	...
	"github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v8/datamongodbatlasthirdpartyintegration/internal"
...
func (j *jsiiProxy_DataMongodbatlasThirdPartyIntegration) SendUserProvidedResourceTags() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.39.0/docs/data-sources/third_party_integration mongodbatlas_third_party_integration} Data Source.
