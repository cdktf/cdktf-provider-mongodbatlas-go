...
import (
	...
	"github.com/cdktf/cdktf-provider-mongodbatlas-go/mongodbatlas/v6/datamongodbatlasthirdpartyintegration/internal"
...
func (j *jsiiProxy_DataMongodbatlasThirdPartyIntegration) ApiToken() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiToken",
...
func (j *jsiiProxy_DataMongodbatlasThirdPartyIntegration) LicenseKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"licenseKey",
...
func (j *jsiiProxy_DataMongodbatlasThirdPartyIntegration) Scheme() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scheme",
...
func (j *jsiiProxy_DataMongodbatlasThirdPartyIntegration) SchemeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schemeInput",
...
// Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.12.2/docs/data-sources/third_party_integration mongodbatlas_third_party_integration} Data Source.
...
func (j *jsiiProxy_DataMongodbatlasThirdPartyIntegration)SetScheme(val *string) {
...
func (d *jsiiProxy_DataMongodbatlasThirdPartyIntegration) ResetScheme() {
	_jsii_.InvokeVoid(
		d,
		"resetScheme",
		nil, // no parameters
