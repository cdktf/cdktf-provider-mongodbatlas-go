...
func (c *jsiiProxy_CloudProviderAccessAuthorizationAzureOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudProviderAccessAuthorizationAzureOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
