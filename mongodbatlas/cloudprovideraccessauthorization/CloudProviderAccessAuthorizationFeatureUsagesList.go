...
func (c *jsiiProxy_CloudProviderAccessAuthorizationFeatureUsagesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudProviderAccessAuthorizationFeatureUsagesList) Resolve(context cdktf.IResolveContext) interface{} {
