...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasMongodbEmployeeAccessGrant)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.dataMongodbatlasMongodbEmployeeAccessGrant.DataMongodbatlasMongodbEmployeeAccessGrantConfig",
		reflect.TypeOf((*DataMongodbatlasMongodbEmployeeAccessGrantConfig)(nil)).Elem(),
	)
}
