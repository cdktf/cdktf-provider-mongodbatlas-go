...
func (d *jsiiProxy_DataMongodbatlasStreamPrivatelinkEndpointsResultsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasStreamPrivatelinkEndpointsResultsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
