...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FederatedSettingsOrgConfig)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "domainRestrictionEnabledInput", GoGetter: "DomainRestrictionEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "postAuthRoleGrantsInput", GoGetter: "PostAuthRoleGrantsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPostAuthRoleGrants", GoMethod: "ResetPostAuthRoleGrants"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.federatedSettingsOrgConfig.FederatedSettingsOrgConfigConfig",
		reflect.TypeOf((*FederatedSettingsOrgConfigConfig)(nil)).Elem(),
	)
}
