...
func (d *jsiiProxy_DataMongodbatlasDatabaseUsersResultsScopesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasDatabaseUsersResultsScopesList) Resolve(context cdktf.IResolveContext) interface{} {
