...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkContainer)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.networkContainer.NetworkContainerConfig",
		reflect.TypeOf((*NetworkContainerConfig)(nil)).Elem(),
	)
}
