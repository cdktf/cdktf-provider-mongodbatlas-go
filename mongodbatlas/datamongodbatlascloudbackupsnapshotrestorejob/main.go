...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasCloudBackupSnapshotRestoreJob)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSnapshotRestoreJobId", GoMethod: "ResetSnapshotRestoreJobId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "snapshotRestoreJobIdInput", GoGetter: "SnapshotRestoreJobIdInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.dataMongodbatlasCloudBackupSnapshotRestoreJob.DataMongodbatlasCloudBackupSnapshotRestoreJobConfig",
		reflect.TypeOf((*DataMongodbatlasCloudBackupSnapshotRestoreJobConfig)(nil)).Elem(),
	)
}
