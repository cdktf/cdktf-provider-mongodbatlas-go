...
func (d *jsiiProxy_DataMongodbatlasLdapConfigurationUserToDnMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasLdapConfigurationUserToDnMappingList) Resolve(context cdktf.IResolveContext) interface{} {
