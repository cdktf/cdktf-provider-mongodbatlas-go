...
func (a *jsiiProxy_AlertConfigurationMatcherList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (a *jsiiProxy_AlertConfigurationMatcherList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
