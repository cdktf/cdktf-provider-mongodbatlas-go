...
func (a *jsiiProxy_AlertConfigurationNotificationList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (a *jsiiProxy_AlertConfigurationNotificationList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
