...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "flowdockApiTokenInput", GoGetter: "FlowdockApiTokenInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFlowdockApiToken", GoMethod: "ResetFlowdockApiToken"},
