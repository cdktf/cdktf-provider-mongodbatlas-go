...
func (d *jsiiProxy_DataMongodbatlasFederatedSettingsOrgConfigUserConflictsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasFederatedSettingsOrgConfigUserConflictsList) Resolve(context cdktf.IResolveContext) interface{} {
