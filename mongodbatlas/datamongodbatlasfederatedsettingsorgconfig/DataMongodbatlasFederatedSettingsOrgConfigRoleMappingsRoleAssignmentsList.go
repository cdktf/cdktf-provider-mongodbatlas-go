...
func (d *jsiiProxy_DataMongodbatlasFederatedSettingsOrgConfigRoleMappingsRoleAssignmentsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasFederatedSettingsOrgConfigRoleMappingsRoleAssignmentsList) Resolve(context cdktf.IResolveContext) interface{} {
