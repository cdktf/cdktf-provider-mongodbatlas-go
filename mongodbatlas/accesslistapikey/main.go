...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AccessListApiKey)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.accessListApiKey.AccessListApiKeyConfig",
		reflect.TypeOf((*AccessListApiKeyConfig)(nil)).Elem(),
	)
}
