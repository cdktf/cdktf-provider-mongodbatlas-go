...
func (j *jsiiProxy_AdvancedClusterReplicationSpecsRegionConfigsElectableSpecsOutputReference) DiskSizeGb() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"diskSizeGb",
...
func (j *jsiiProxy_AdvancedClusterReplicationSpecsRegionConfigsElectableSpecsOutputReference) DiskSizeGbInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"diskSizeGbInput",
...
func (j *jsiiProxy_AdvancedClusterReplicationSpecsRegionConfigsElectableSpecsOutputReference)SetDiskSizeGb(val *float64) {
...
func (a *jsiiProxy_AdvancedClusterReplicationSpecsRegionConfigsElectableSpecsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AdvancedClusterReplicationSpecsRegionConfigsElectableSpecsOutputReference) ResetDiskSizeGb() {
	_jsii_.InvokeVoid(
		a,
		"resetDiskSizeGb",
		nil, // no parameters
...
func (a *jsiiProxy_AdvancedClusterReplicationSpecsRegionConfigsElectableSpecsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
