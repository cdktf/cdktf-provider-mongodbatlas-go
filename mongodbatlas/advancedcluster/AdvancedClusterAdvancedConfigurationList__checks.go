...
func (a *jsiiProxy_AdvancedClusterAdvancedConfigurationList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_AdvancedClusterAdvancedConfigurationList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*AdvancedClusterAdvancedConfiguration; received %#v (a %T)", val, val)
		}
	}
