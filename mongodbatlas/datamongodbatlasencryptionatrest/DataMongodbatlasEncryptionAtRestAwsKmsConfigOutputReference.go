...
func (d *jsiiProxy_DataMongodbatlasEncryptionAtRestAwsKmsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataMongodbatlasEncryptionAtRestAwsKmsConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
