...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "clusterProjectIdInput", GoGetter: "ClusterProjectIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetClusterProjectId", GoMethod: "ResetClusterProjectId"},
