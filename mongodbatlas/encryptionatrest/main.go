...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enabledForSearchNodesInput", GoGetter: "EnabledForSearchNodesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnabledForSearchNodes", GoMethod: "ResetEnabledForSearchNodes"},
