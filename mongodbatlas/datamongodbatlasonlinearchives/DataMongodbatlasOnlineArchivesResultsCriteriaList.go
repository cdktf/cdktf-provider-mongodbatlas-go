...
func (d *jsiiProxy_DataMongodbatlasOnlineArchivesResultsCriteriaList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasOnlineArchivesResultsCriteriaList) Resolve(context cdktf.IResolveContext) interface{} {
