...
// Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.26.0/docs/data-sources/event_trigger mongodbatlas_event_trigger} Data Source.
...
func DataMongodbatlasEventTrigger_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataMongodbatlasEventTrigger_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataMongodbatlasEventTrigger) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataMongodbatlasEventTrigger) ToHclTerraform() interface{} {
	var returns interface{}
