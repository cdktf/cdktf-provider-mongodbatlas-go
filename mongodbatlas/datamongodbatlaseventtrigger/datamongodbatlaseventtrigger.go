...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasEventTrigger)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.dataMongodbatlasEventTrigger.DataMongodbatlasEventTriggerConfig",
		reflect.TypeOf((*DataMongodbatlasEventTriggerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.dataMongodbatlasEventTrigger.DataMongodbatlasEventTriggerEventProcessors",
		reflect.TypeOf((*DataMongodbatlasEventTriggerEventProcessors)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-mongodbatlas.dataMongodbatlasEventTrigger.DataMongodbatlasEventTriggerEventProcessorsAwsEventbridge",
		reflect.TypeOf((*DataMongodbatlasEventTriggerEventProcessorsAwsEventbridge)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-mongodbatlas.dataMongodbatlasEventTrigger.DataMongodbatlasEventTriggerEventProcessorsAwsEventbridgeList",
		reflect.TypeOf((*DataMongodbatlasEventTriggerEventProcessorsAwsEventbridgeList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasEventTriggerEventProcessorsAwsEventbridgeOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasEventTriggerEventProcessorsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataMongodbatlasEventTriggerEventProcessorsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
