...
func (d *jsiiProxy_DataMongodbatlasGlobalClusterConfigManagedNamespacesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasGlobalClusterConfigManagedNamespacesList) Resolve(context cdktf.IResolveContext) interface{} {
