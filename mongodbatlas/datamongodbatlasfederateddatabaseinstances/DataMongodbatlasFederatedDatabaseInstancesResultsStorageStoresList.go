...
func (d *jsiiProxy_DataMongodbatlasFederatedDatabaseInstancesResultsStorageStoresList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataMongodbatlasFederatedDatabaseInstancesResultsStorageStoresList) Resolve(context cdktf.IResolveContext) interface{} {
