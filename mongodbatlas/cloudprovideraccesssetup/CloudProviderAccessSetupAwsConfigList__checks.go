...
func (c *jsiiProxy_CloudProviderAccessSetupAwsConfigList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (c *jsiiProxy_CloudProviderAccessSetupAwsConfigList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
